...
echo
echo Continue to create GitHub TAP GitOps Repo tap-gitops-createkey
echo     https://github.com/tfynes-pivotal/tap-gitops-tap-gitops-createkey
echo
...
git add .
git commit -am "."
gh repo create tap-gitops-createkey --public
git remote add origin https://github.com/tfynes-pivotal/tap-gitops-createkey
git branch -M main
